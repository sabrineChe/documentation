...
***************************
The architecture of the Collection API service is illustrated in Figure 1. The bottom component is the Collection API core, which includes the collection 
